...
# # Instantiates all exists with ?s
...
# do a depth first -- once I hit a dead end


# traverse backwards to the first "?"

#when I hit a dead end, should I retrace steps( to log the path back?)
#or should I traverse to find the next point of exploration?
# TRAVERSAL TEST
visited_rooms = set()
